      ...
      <div className="flex-1 flex items-center justify-center p-4 relative z-10">
        <div className="w-full max-w-md animate-fade-in">
          ...
          <div className="text-center mb-10">
            <div className="mx-auto w-40 h-20 mb-8 relative group">
              <img 
                src={mlvsLogo} 
                alt="MLVS District" 
                className="w-full h-full object-contain filter drop-shadow-2xl transition-transform duration-300 group-hover:scale-105"
              />
              <div className="absolute inset-0 bg-gradient-to-br from-blue-500/30 to-purple-500/30 rounded-lg blur-2xl animate-pulse"></div>
              {/* Glow effect */}
              <div className="absolute inset-0 bg-gradient-to-br from-white/10 to-white/5 rounded-lg animate-pulse" style={{animationDelay: '0.5s'}}></div>
            </div>
